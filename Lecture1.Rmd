...
knitr::include_graphics(rep("images/cranwindow.png"))
```  

**Click on "install R for the first time"**.
```{r crandown2, echo=FALSE,fig.cap= "",out.width="70%", fig.align='center'}
knitr::include_graphics(rep("images/cranwindow2.png"))
```  
...
knitr::include_graphics(rep("images/cranwindow3.png"))
``` 
...
knitr::include_graphics(rep("images/Rfinal.png"))
```
...
knitr::include_graphics(rep("images/rstudio1.png"))
``` 
